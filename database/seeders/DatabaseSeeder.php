    ...
    public function run(): void
    {
        ...
        $leads = [
            [
                ...
                'empresa' => 'Fuente Italiana Providencia',
                'email' => 'rodrigo@fuenteitaliana.cl',
                'telefono' => '+56998765432',
                'comuna' => 'Providencia',
                'region' => 'Metropolitana',
                'cantidad_estimada_kg' => 250,
                'tipo_cliente' => 'restaurante',
                'mensaje' => 'Requerimos 250 kg semanales de calibre Extra para sándwiches italianos.',
                'pagina_origen' => '/paltas-para-restaurantes',
                'utm_source' => 'google',
                'utm_medium' => 'cpc',
                'utm_campaign' => 'restaurantes_santiago',
                'estado' => 'Cotización enviada',
            ],
            [
                'nombre' => 'Camila Henríquez',
                'empresa' => 'Casino Central Vitacura',
                'email' => 'chenriquez@casinoscentrales.cl',
                'telefono' => '+56987654321',
                'comuna' => 'Vitacura',
                'region' => 'Metropolitana',
                'cantidad_estimada_kg' => 1200,
                'tipo_cliente' => 'casino',
                'mensaje' => 'Licitación trimestral para casino corporativo. Necesitamos certificación de BPM y entrega en bins.',
                'pagina_origen' => '/paltas-para-casinos',
                'utm_source' => 'organico',
                'utm_medium' => 'seo',
                'utm_campaign' => 'casinos_b2b',
                'estado' => 'Negociación',
            ],
            [
                'nombre' => 'Matías Valenzuela',
                'empresa' => 'Sushi Hanami Las Condes',
                'email' => 'compras@sushihanami.cl',
                'telefono' => '+56976543210',
                'comuna' => 'Las Condes',
                'region' => 'Metropolitana',
                'cantidad_estimada_kg' => 180,
                'tipo_cliente' => 'restaurante',
                'mensaje' => 'Buscamos palta calibre Primera con textura consistente para corte en abanico.',
                'pagina_origen' => '/venta-de-paltas-en-las-condes',
                'utm_source' => 'google',
                'utm_medium' => 'search',
                'utm_campaign' => 'paltas_las_condes',
                'estado' => 'Nuevo',
            ],
            [
                'nombre' => 'Andrea Silva',
                'empresa' => 'Minimarket Don Pepe',
                'email' => 'asilva@donpepe.cl',
                'telefono' => '+56965432109',
                'comuna' => 'Ñuñoa',
                'region' => 'Metropolitana',
                'cantidad_estimada_kg' => 100,
                'tipo_cliente' => 'minimarket',
                'mensaje' => 'Cotización para abastecimiento semanal de mallas y cajas.',
                'pagina_origen' => '/',
                'utm_source' => 'directo',
                'utm_medium' => null,
                'utm_campaign' => null,
        ...
        foreach ($leads as $leadData) {
            ...
            LeadHistory::create([
                ...
                'descripcion' => 'Lead ingresado a través de ' . $lead->pagina_origen,
            ]);

            // Add note if lead is in negotiation
            if ($lead->estado === 'Negociación') {
                LeadNote::create([
                    'lead_id' => $lead->id,
                    'user_id' => $superAdmin->id,
                    'nota' => 'Se envió propuesta con descuento por volumen superior a 1 tonelada mensual. Pendiente reunión con jefe de compras.',
                ]);
            }
        }
    }
